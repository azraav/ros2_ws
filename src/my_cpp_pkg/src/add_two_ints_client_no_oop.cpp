...
int main(int argc, char **argv)
{
    ...
    //rclcpp::spin(node); we will not spin the node, we will just create a clinet, send a client, wait for the server response

    auto client = node -> create_client<example_interfaces::srv::AddTwoInts>("add_two_ints"); //args type, in brackets add service name 
