...
: ${AMENT_CURRENT_PREFIX:="/home/azraa/ros2_ws/src/install/m2s2_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/m2s2_bringup/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/m2s2_bringup/environment/path.sh"
