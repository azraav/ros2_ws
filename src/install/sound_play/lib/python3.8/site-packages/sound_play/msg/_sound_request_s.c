...
bool sound_play__msg__sound_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sound_play.msg._sound_request.SoundRequest", full_classname_dest, 42) == 0);
  }
  sound_play__msg__SoundRequest * ros_message = _ros_message;
  {  // sound
...
PyObject * sound_play__msg__sound_request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sound_play.msg._sound_request");
