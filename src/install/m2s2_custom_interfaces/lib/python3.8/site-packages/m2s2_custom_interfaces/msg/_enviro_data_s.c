...
bool m2s2_custom_interfaces__msg__enviro_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("m2s2_custom_interfaces.msg._enviro_data.EnviroData", full_classname_dest, 50) == 0);
  }
  m2s2_custom_interfaces__msg__EnviroData * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of EnviroData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("m2s2_custom_interfaces.msg._enviro_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EnviroData");
