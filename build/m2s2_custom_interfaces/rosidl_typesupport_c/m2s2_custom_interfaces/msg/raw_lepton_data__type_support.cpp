...
static const _RawLeptonData_type_support_symbol_names_t _RawLeptonData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, m2s2_custom_interfaces, msg, RawLeptonData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, m2s2_custom_interfaces, msg, RawLeptonData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, m2s2_custom_interfaces, msg, RawLeptonData)() {
  return &::m2s2_custom_interfaces::msg::rosidl_typesupport_c::RawLeptonData_message_type_support_handle;
}
