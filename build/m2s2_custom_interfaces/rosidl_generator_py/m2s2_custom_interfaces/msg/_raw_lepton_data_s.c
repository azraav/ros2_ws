...
bool m2s2_custom_interfaces__msg__raw_lepton_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("m2s2_custom_interfaces.msg._raw_lepton_data.RawLeptonData", full_classname_dest, 57) == 0);
  }
  m2s2_custom_interfaces__msg__RawLeptonData * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of RawLeptonData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("m2s2_custom_interfaces.msg._raw_lepton_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RawLeptonData");
