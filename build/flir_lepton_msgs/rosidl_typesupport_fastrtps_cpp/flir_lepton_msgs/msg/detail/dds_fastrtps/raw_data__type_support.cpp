...
#include "flir_lepton_msgs/msg/detail/raw_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const flir_lepton_msgs::msg::RawData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  flir_lepton_msgs::msg::RawData & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const flir_lepton_msgs::msg::RawData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<flir_lepton_msgs::msg::RawData *>(
    untyped_ros_message);
...
{
  return &flir_lepton_msgs::msg::typesupport_fastrtps_cpp::_RawData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, flir_lepton_msgs, msg, RawData)() {
  return &flir_lepton_msgs::msg::typesupport_fastrtps_cpp::_RawData__handle;
}
