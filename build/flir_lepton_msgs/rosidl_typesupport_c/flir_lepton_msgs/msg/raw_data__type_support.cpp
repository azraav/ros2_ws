...
static const _RawData_type_support_symbol_names_t _RawData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flir_lepton_msgs, msg, RawData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flir_lepton_msgs, msg, RawData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, flir_lepton_msgs, msg, RawData)() {
  return &::flir_lepton_msgs::msg::rosidl_typesupport_c::RawData_message_type_support_handle;
}
