...
#include "flir_lepton_msgs/msg/detail/raw_data__rosidl_typesupport_fastrtps_c.h"
...
using _RawData__ros_msg_type = flir_lepton_msgs__msg__RawData;
...
size_t get_serialized_size_flir_lepton_msgs__msg__RawData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RawData__ros_msg_type * ros_message = static_cast<const _RawData__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RawData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_flir_lepton_msgs__msg__RawData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_flir_lepton_msgs
size_t max_serialized_size_flir_lepton_msgs__msg__RawData(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_flir_lepton_msgs__msg__RawData(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flir_lepton_msgs, msg, RawData)() {
