...
static const _RawData_type_support_symbol_names_t _RawData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, flir_lepton_msgs, msg, RawData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, flir_lepton_msgs, msg, RawData)),
  }
};
...
{
  return &::flir_lepton_msgs::msg::rosidl_typesupport_cpp::RawData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, flir_lepton_msgs, msg, RawData)() {
  return get_message_type_support_handle<flir_lepton_msgs::msg::RawData>();
}
