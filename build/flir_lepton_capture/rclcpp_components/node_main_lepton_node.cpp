...
#define NODE_MAIN_LOGGER_NAME "lepton_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libflir_lepton_capture.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<FlirLepton::FlirLepton>";
