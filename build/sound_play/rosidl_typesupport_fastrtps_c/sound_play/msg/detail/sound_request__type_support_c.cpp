...
#include "sound_play/msg/detail/sound_request__rosidl_typesupport_fastrtps_c.h"
...
using _SoundRequest__ros_msg_type = sound_play__msg__SoundRequest;
...
static uint32_t _SoundRequest__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sound_play__msg__SoundRequest(
...
static size_t _SoundRequest__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_sound_play__msg__SoundRequest(
    full_bounded, 0);
}
