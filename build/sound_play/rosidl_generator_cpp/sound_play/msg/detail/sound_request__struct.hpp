...
#ifndef SOUND_PLAY__MSG__DETAIL__SOUND_REQUEST__STRUCT_HPP_
#define SOUND_PLAY__MSG__DETAIL__SOUND_REQUEST__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__sound_play__msg__SoundRequest __attribute__((deprecated))
#else
# define DEPRECATED__sound_play__msg__SoundRequest __declspec(deprecated)
#endif
...
struct SoundRequest_
{
  ...
  using ConstRawPtr =
    const sound_play::msg::SoundRequest_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<sound_play::msg::SoundRequest_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<sound_play::msg::SoundRequest_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      sound_play::msg::SoundRequest_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<sound_play::msg::SoundRequest_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<sound_play::msg::SoundRequest_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<sound_play::msg::SoundRequest_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<sound_play::msg::SoundRequest_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__sound_play__msg__SoundRequest
    std::shared_ptr<sound_play::msg::SoundRequest_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__sound_play__msg__SoundRequest
    std::shared_ptr<sound_play::msg::SoundRequest_<ContainerAllocator> const>
...
using SoundRequest =
  sound_play::msg::SoundRequest_<std::allocator<void>>;
...
#endif  // SOUND_PLAY__MSG__DETAIL__SOUND_REQUEST__STRUCT_HPP_
