...
#include "sound_play/msg/detail/sound_request__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const sound_play::msg::SoundRequest *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sound_play::msg::SoundRequest *>(
    untyped_ros_message);
...
{
  return max_serialized_size_SoundRequest(full_bounded, 0);
}
...
{
  return &sound_play::msg::typesupport_fastrtps_cpp::_SoundRequest__handle;
}
