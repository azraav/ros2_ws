...
static const _SoundRequest_type_support_symbol_names_t _SoundRequest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sound_play, msg, SoundRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sound_play, msg, SoundRequest)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sound_play, msg, SoundRequest)() {
  return &::sound_play::msg::rosidl_typesupport_c::SoundRequest_message_type_support_handle;
}
