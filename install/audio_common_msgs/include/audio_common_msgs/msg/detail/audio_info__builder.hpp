...
class Init_AudioInfo_header
{
public:
  Init_AudioInfo_header()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_AudioInfo_channels header(::audio_common_msgs::msg::AudioInfo::_header_type arg)
  {
...
{
  return audio_common_msgs::msg::builder::Init_AudioInfo_header();
}
