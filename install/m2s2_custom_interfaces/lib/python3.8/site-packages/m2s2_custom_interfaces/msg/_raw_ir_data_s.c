...
bool m2s2_custom_interfaces__msg__raw_ir_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("m2s2_custom_interfaces.msg._raw_ir_data.RawIrData", full_classname_dest, 49) == 0);
  }
  m2s2_custom_interfaces__msg__RawIrData * ros_message = _ros_message;
  {  // header
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * m2s2_custom_interfaces__msg__raw_ir_data__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of RawIrData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("m2s2_custom_interfaces.msg._raw_ir_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RawIrData");
  ...
  m2s2_custom_interfaces__msg__RawIrData * ros_message = (m2s2_custom_interfaces__msg__RawIrData *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
