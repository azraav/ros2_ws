...
bool flir_lepton_msgs__msg__temperature_raw__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("flir_lepton_msgs.msg._temperature_raw.TemperatureRaw", full_classname_dest, 52) == 0);
  }
  flir_lepton_msgs__msg__TemperatureRaw * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of TemperatureRaw */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("flir_lepton_msgs.msg._temperature_raw");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TemperatureRaw");
